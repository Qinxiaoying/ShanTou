...
def test(
    ...
    m4_fn = '/home/enso/max_micaps/data/rh.000'
    (
    ...
    product_definition_template[0] = 1
    product_definition_template[1] = 8
    product_definition_template[8] = 0
    product_definition_template[9] = 1
    product_definition_template[10] = 0
    product_definition_template[11] = 0
    ...
    fn = "201703021700_MICAPS-precip_CHINA_27km" 
    f=open(fn + '.grib2','wb')
    grbo = Grib2Encode(
        discipline_code,
        identification_section)
