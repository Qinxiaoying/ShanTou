...
grid_definition_info = [
    ...
    # @ 0 for regular grids. Number of octets needed for each additional grid points defn.
    0,
                 # Used to define number of points in each row for non-reg
                 # grids (=0 for regular grid).
    0,           # http://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_table3-11.shtml
    0            # @ 0 for Latitude/Longitude. http://www.nco.ncep.noaa.gov/pmb/docs/grib2/grib2_table3-1.shtml
]
grid_definition_template = [
    # @ 6 for Earth assumed spherical with radius = 6,371,229.0 m. Shape of the Earth (See Code Table 3.2)
    6,
...
# grbo.addfield(product_definition_template_number, product_definition_template,
# data_representation_template_number,  data_representation_template, data)
...
product_definition_template = [
    ...
    # @ 2 for Forecast. Type of generating process (see Code table 4.3)
    2,
    # Background generating process identifier (defined by originating centre)
    0,
    # Analysis or forecast generating process identified (see Code ON388 Table
    # A)
    96,
    ...
    0,
    # @ 1 for hour. Indicator of unit of time range (see Code table 4.4)
    1,
    120,        # @ fcst valid for 120 hours. Forecast time in units defined by octet 18
    # @ 100 for isobar, 1 for Ground or water surface, 103 for height about ground.
    100,
...
data_representation_template = [1156603904, 0, 1,
                                8, 0, 1, 0, 0, 0, 696, 0, 3, 1, 1, 32, 5, 1, 1]
...
def test(
    ...
    m4_fn = '/home/enso/max_micaps/data/vis.000'
    (data, stlon, edlon, stlat, edlat, xnum,
     ynum, xdelta, ydelta) = read_micaps_iv(m4_fn)
    ...
    product_definition_template[0] = 19
    ...
    product_definition_template[11] = 100000
    ...
    fn = "201703021700_MICAPS-vis_YUNNAN_10km"
    f = open(fn + '.grib2', 'wb')
    grbo = Grib2Encode(
        discipline_code,
        identification_section)
